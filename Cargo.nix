    ...
    crates = {
      ...
      "armazem" = rec {
        ...
        crateBin = [
          ...
          {
            name = "armazem-publish";
            path = "src/bin/armazem-publish.rs";
            requiredFeatures = [ ];
          }
        ];
      ...
      "hex-simd" = rec {
        ...
        version = "0.8.0";
        edition = "2021";
        sha256 = "1viv1llx4s81fv8n2y93xyw1ifp9a5fjzwq54vy0xhiznnz8axhz";
        libName = "hex_simd";
        dependencies = [
          {
            name = "outref";
      ...
      "hyper-util" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "http1" "http2" "server" "server-auto" "server-graceful" "service" "tokio" ];
      };
      "iana-time-zone" = rec {
      ...
      "md-5" = rec {
        ...
        version = "0.11.0-rc.5";
        edition = "2024";
        sha256 = "12327akjqxz8wd1qsk5pca6710zbbr7nqga0i7y6hc17dyxibrsr";
        libName = "md5";
        authors = [
          "RustCrypto Developers"
        ];
      ...
      "numeric_cast" = rec {
        crateName = "numeric_cast";
        version = "0.3.0";
        edition = "2021";
        sha256 = "14z0q6ph4nf0dfc8cj5zlg5p4xkacy8dwwl95z9rndq0jq60mh53";
      ...
      "s3s" = rec {
        ...
        version = "0.13.0";
        edition = "2024";
        sha256 = "12p9lp1259l6bv6n3iyb7dsap4rpqwsfk8z5sj9gvrdsm4n5gxgw";
        dependencies = [
          {
            name = "arc-swap";
            packageId = "arc-swap";
      ...
      "s3s-fs" = rec {
        ...
        edition = "2024";
        crateBin = [];
        sha256 = "1c9lvfn36ayarvi2bhnr9g1mddsp5f2zvx94mk6l3mfqq1g9m1v3";
        libName = "s3s_fs";
        dependencies = [
          {
            name = "async-trait";
      ...
      "sha1" = rec {
        ...
        version = "0.11.0-rc.5";
        edition = "2024";
        sha256 = "02kmrfgyimqgvfrw802r8h0hz5868x69qqr6i46vw9n1yd9745iv";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "sha2" = rec {
        ...
        version = "0.11.0-rc.5";
        edition = "2024";
        sha256 = "0900bm3n9lq0md96q5yabykfr071sza0nhfq221x5an85lg3npvw";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "std-next" = rec {
        ...
        version = "0.1.9";
        edition = "2021";
        sha256 = "1g7fbd65kynks7hl8py61ckczlj69cijija8j6yxw1hsxn9jw204";
        libName = "stdx";
        dependencies = [
          {
            name = "simdutf8";
      ...
      "transform-stream" = rec {
        crateName = "transform-stream";
        version = "0.3.1";
        edition = "2021";
        sha256 = "08i0hgll8iikgkf0qcy3mi2gn2x6mai36792yrvkb5ipak919a61";
        libName = "transform_stream";
        authors = [
